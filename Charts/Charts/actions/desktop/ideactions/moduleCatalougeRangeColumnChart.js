function rangeColumnChartCatalouge() {
    
    this.demos = {};
    this.demos.demoNames = [];
    this.demos.demoObjects = [];
    this.demos.docURL = "http://docs.kony.com/konylibrary/Subsystems/Kony_Charts_User_Guide/Content/Chart_rangecolumnchart.htm";
    ...
    this.pushDemo("Single Series", k_dv_dataviz_rangecolumnchart_2_demo_1);
    this.pushDemo("Multi Series", k_dv_dataviz_rangecolumnchart_2_demo_2);
};
///////////////////////////////////////////////////
///////////////////////////////////////////////////
///////////////////////////////////////////////////
function k_dv_dataviz_rangecolumnchart_2_demo_1() {
    var chartInfo = {
        "chartProperties": {
            "chartHeight": 67,
            "title": {
            ...
            "drawEntities": ["axis", "grid", "rangeColumnChart"],
            "rangeColumnChart": {
                "columnId": [0, 1],
                "animations": {
...
///////////////////////////////////////////////////
///////////////////////////////////////////////////
function k_dv_dataviz_rangecolumnchart_2_demo_2() {
    var chartInfo = {
        "chartProperties": {
        ...
        "chartData": {
            ...
            "columnNames": {
                "values": ["Hyderabad Min Temperature",
                           "Hyderabad Max Temperature",
                           "Banglore Min Temperature",
                           "Banglore Max Temperature",
                           "Chennai Min Temperature",
                           "Chennai Max Temperature"]
            },
            "data": {
